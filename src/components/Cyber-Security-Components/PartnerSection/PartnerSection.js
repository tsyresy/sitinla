          ...
          <div className="xb-holder">
            <span className="sub-title">
              <span data-parallax='{"x":50,"y":70}'>
                <span className="sub-title--inner"><span>Grâce à nous</span></span>
            ...
            <h2 className="title"> <span>+30,45K clients</span> Satisfaits</h2>
            <span className="sub-title sub-title--two">
              <span data-parallax='{"x":-50,"y":-70}'>
                ...
                </svg><span className="sub-title--inner"><span>Rapide et sécurisé</span></span>
              </span>
            </span>
          </div>
        </div>
